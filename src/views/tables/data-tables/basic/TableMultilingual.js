...
const DataTableWithButtons = ({mydata, title}) => {
  // ** State
  ...
  const CustomPagination = () => (
    <ReactPaginate
      ...
      containerClassName={`pagination react-paginate pagination-sm justify-content-center pr-1 mt-1
        ${(mydata.length <= 7 || (searchValue.length && searchValue.length <= 7)) && "d-none"}`}
    />
  )
    ...
    <Card>
      ...
      <Row className='justify-content-start mx-0'>
        <Col className='d-flex align-items-center justify-content-end mt-1' md='6' sm='12'>
          <Label className='mx-1' for='search-input-1'>
